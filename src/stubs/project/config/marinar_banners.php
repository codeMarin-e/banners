...
return [
     ...
     */
    'install_behavior' => env('MARINAR_BANNERS_INSTALL_BEHAVIOR', env('MARINAR_INSTALL_BEHAVIOR', true)),
     ...
     * 2 - keep everything
     */
    'delete_behavior' => env('MARINAR_BANNERS_DELETE_BEHAVIOR', env('MARINAR_DELETE_BEHAVIOR', false)),
     ...
     */
    'addons' => [
        // @HOOK_BANNERS_CONFIGS_ADDONS
    ],
    // @HOOK_BANNERS_CONFIGS
];
